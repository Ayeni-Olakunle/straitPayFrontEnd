...
function TodoApp() {
  ...
  return (
    <main className="h-screen w-full flex justify-between items-center overflow-hidden">
      <div className="w-1/2 bg-[#407BFF] h-full flex justify-center items-center md:hidden">
        <img src={think} alt="Not Available" className="h-[500px]"/>
      </div>
      <div className="w-1/2 h-full p-[20px] overflow-y-scroll md:w-full">
        <h1 className="text-[#407BFF] text-[40px] font-bold text-center mx-[0] my-[10px]">Todo List App</h1>

        <div className="w-full flex justify-center items-center">
          <div className="w-[60%] md:w-full flex justify-between items-center mx-[0] my-[15px] border-[2px] border-solid border-[#407BFF] rounded-[5px]">
